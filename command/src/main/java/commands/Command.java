...
public class Command {
    ...
    public static final String CHENGNICKNAME = "/chengnikenameo";
    public static final String CHENGNICKNAME_OK = "/chengnikenameok";
    public static final String CHENGNICKNAME_NO = "/chengnikenameno";
}
